...
def data_wrangling():
    df = pd.read_csv('data/API_SP.RUR.TOTL.ZS_DS2_en_csv_v2_718759.csv', skiprows=4)

    # Filter for 1990 and 2015, top 10 economies + a shitty one ;)
    df = df[['Country Name', '1990', '2015']]
    countrylist = ['United States', 'China', 'Japan', 'Germany', 'United Kingdom',
                   'India', 'France', 'Brazil', 'Italy', 'Canada', 'Colombia']
